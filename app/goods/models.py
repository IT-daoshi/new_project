...
class GoodsSKU(BaseModel):
    ...
    sales = models.IntegerField(default=0, verbose_name='商品存量')
    status = models.SmallIntegerField(default=1, choices=STATUS_CHOICES, verbose_name='商品种类')
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=0, verbose_name='展示顺序')
